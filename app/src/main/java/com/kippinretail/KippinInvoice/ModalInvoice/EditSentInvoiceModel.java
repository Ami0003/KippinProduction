...
/**
 * Created by Codewix Dev on 7/2/2017.
 */
...
public class EditSentInvoiceModel {
    ...
    @Expose
    private List<Double> serviceTypeId = null;
    ...
    public List<Double> getServiceTypeId() {
        return serviceTypeId;
    }

    public void setServiceTypeId(List<Double> serviceTypeId) {
