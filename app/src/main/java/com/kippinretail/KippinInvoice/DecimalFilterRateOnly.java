...
public class DecimalFilterRateOnly implements TextWatcher {

    int count = -1;
    EditText et;
    Activity activity;

    public DecimalFilterRateOnly(EditText edittext, Activity activity) {
        et = edittext;
            ...
            et.setOnKeyListener(new OnKeyListener() {
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        ...
                        fArray[0] = new InputFilter.LengthFilter(1000);//Re sets the maxLength of edittext to 100.
