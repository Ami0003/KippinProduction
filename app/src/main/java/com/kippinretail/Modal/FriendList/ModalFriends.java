package com.kippinretail.Modal.FriendList;
 ...
 */
public class ModalFriends extends ModalResponse{
    private String Age;
    ...
    private String IsLoyalityCardActive;
    ...
    private String IsSubscribedMerchant;
    ...
    public String getIsLoyalityCardActive ()
    {
        return IsLoyalityCardActive;
    }

    public void setIsLoyalityCardActive (String IsLoyalityCardActive)
    {
    ...
    public String getIsSubscribedMerchant ()
    {
        return IsSubscribedMerchant;
    }

    public void setIsSubscribedMerchant (String IsSubscribedMerchant)
    {
    ...
    {
        return "ClassPojo [Age = "+Age+", IsInvited = "+IsInvited+", Password = "+Password+", Businessdescription = "+Businessdescription+", RefferCodepath = "+RefferCodepath+", Dob = "+Dob+", PrivateKey = "+PrivateKey+", ResponseMessage = "+ResponseMessage+", CharityTypeIdsCommaSeparated = "+CharityTypeIdsCommaSeparated+", MultipleRole = "+MultipleRole+", IsActive = "+IsActive+", MerchantId = "+MerchantId+", Mobile = "+Mobile+", Lastname = "+Lastname+", Firstname = "+Firstname+", IndustryId = "+IndustryId+", BusinessNumber = "+BusinessNumber+", Website = "+Website+", IsEmployee = "+IsEmployee+", DateCreated = "+DateCreated+", ProfileImage = "+ProfileImage+", Location = "+Location+", BusinessName = "+BusinessName+", ResponseCode = "+ResponseCode+", IsLoyalityCardActive = "+IsLoyalityCardActive+", UserId = "+UserId+", MerchantPoint = "+MerchantPoint+", Country = "+Country+", BusinessPhoneNumber = "+BusinessPhoneNumber+", RoleId = "+RoleId+", IsSubscribedMerchant = "+IsSubscribedMerchant+", TermsConditions = "+TermsConditions+", LoyalityBarcode = "+LoyalityBarcode+", Email = "+Email+", DateModified = "+DateModified+", CharityPurpose = "+CharityPurpose+", Gender = "+Gender+", Username = "+Username+", Id = "+Id+", ReferralId = "+ReferralId+", IsAuthenticated = "+IsAuthenticated+", LoyalityCardName = "+LoyalityCardName+", ReferralCode = "+ReferralCode+", Industry = "+Industry+"]";
    }
}
