 ...
 */
public class MerchantVoucherListAdapter extends BaseAdapter implements Filterable {
    Activity mcontext;
    ...
    public MerchantVoucherListAdapter(Activity mcontext, List<MerchantModal> merchant , String parent)
    {
        this.parent  = parent;
    ...
    public View getView(final int position, View view, final ViewGroup parent) {
        ...
        {   holder = new ViewHolder();
            view =  inflate.inflate(R.layout.subitem_merchant_voucher_list,parent,false);
        ...
        if(merchantModal.getProfileImage()!=null && !merchantModal.getProfileImage().equals("")){
            Picasso.with(mcontext).load(merchantModal.getProfileImage()).resize(width, height).placeholder(R.drawable.icon_placeholder).into(holder.imageviewMyPoint);
        }else{
               ...
               MerchantModal modal = (MerchantModal)v.getTag();
                ...
                if(modal.getParent().equals("SelectMerchantActivity"))
                {
                    ...
                    if(modal.getParentButton().equals("giftCardFromThirdParty")){
                        ...
                        i.putExtra("parentButton", MerchantVoucherListAdapter.this.parent);
                    }
