 ...
 */
public class GiftCardListAdapter1 extends BaseAdapter implements Filterable {
    ...
    public GiftCardListAdapter1(List<MerchantDetail> listData , Activity activity,String merchantId){
    ...
    public GiftCardListAdapter1(List<MerchantDetail> listData , Activity activity){
        this.originalData = this.listData = listData;
        this.mContext = activity;
        this.merchantId = merchantId;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        {   holder = new ViewHolder();
            view =  inflater.inflate(R.layout.subitem_merchant_voucher_list,parent,false);
