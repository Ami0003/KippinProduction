 ...
 */
public class MerchantListAdapterModified extends ArrayAdapter<MerchantModal> implements Filterable
{
    Activity mcontext;
    ...
    public MerchantListAdapterModified(Activity mcontext, List<MerchantModal> merchantModals)
    {
    ...
    public MerchantListAdapterModified(Activity mcontext, ArrayList<MerchantModal> merchantModals, boolean isCheckboxNeeded) {
        this(mcontext,merchantModals,isCheckboxNeeded,-1) ;
        this.mcontext = mcontext;
    }

    public MerchantListAdapterModified(Activity mcontext, ArrayList<MerchantModal> merchantModals, boolean isCheckboxNeeded, int btnId) {
        super( mcontext, R.layout.subiterm_merchant_list, merchantModals );
        this.mcontext = mcontext;
        this.originalData_merchantModals = merchantModals;
        this.filterData_merchantModals = merchantModals;
    ...
    public MerchantListAdapterModified(Context mcontext, ArrayList<MerchantModal> merchantModals, boolean isCheckboxNeeded, boolean alternate, int oddId, int evenId) {
        super( mcontext, R.layout.subiterm_merchant_list, merchantModals );
        this.originalData_merchantModals = merchantModals;
        this.filterData_merchantModals = merchantModals;
        inflater = LayoutInflater.from(mcontext) ;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(filterData_merchantModals !=null) {
            ...
            CircleImageView imageviewMyPoint=null;
            ImageView iv_star;
            Switch swtch;
            if (view == null) {
                view = inflater.inflate(R.layout.subitem_charity_merchant_list, parent, false);
                txtview = (TextView) view.findViewById(R.id.txtMerchant);
                swtch = (Switch) view.findViewById(R.id.chbMerchant);
                imageviewMyPoint = (CircleImageView)view.findViewById(R.id.imageviewMyPoint);
    ...
    private class ViewHolder {
        TextView username;
        Switch swtch;
        CircleImageView imageviewMyPoint;
        ...
        public CircleImageView getImageviewMyPoint() {
            return imageviewMyPoint;
        }

        public void setImageviewMyPoint(CircleImageView imageviewMyPoint) {
        ...
        public ViewHolder(TextView username, Switch swtch , RelativeLayout layout_myPoint,CircleImageView imageviewMyPoint,ImageView iv_star) {
            this.iv_star = iv_star;
