package com.kippinretail.sharedpreferences;
...
public class Prefs {
    ...
    static SharedPreferences.Editor editorInvoice;
    private static Gson GSON = new Gson();

    Prefs(Context context) {
        preferences = context.getSharedPreferences(TAG, Context.MODE_PRIVATE);
        editor = preferences.edit();
        editorInvoice = preferences.edit();
    }
    ...
    public void saveInvoice(String key, String value) {
        editorInvoice.putString(key, value).apply();
    }
    ...
    // to save object in prefrence
    public void saveInvoice(String key, Object object) {
        if (object == null) {
            throw new IllegalArgumentException("object is null");
        }
        ...
        editorInvoice.putString(key, GSON.toJson(object)).apply();
    }
