 ...
 */
public class IndustryAdapter extends ArrayAdapter<ModelIndustry> {

    private LayoutInflater mInflater;
    Context mContext;
    ArrayList<ModelIndustry> arrayList;
    public IndustryAdapter(Context context, int resource, ArrayList<ModelIndustry> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.textViewName.setText(arrayList.get(position).getIndustryType());
