...
public class Month_YearPicker {
     ...
     */
    public Month_YearPicker(Activity activity) {
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        builder.setPositiveButton("Select", positiveButtonListener);
        builder.setNegativeButton("Proceed", negativeButtonListener);
        build = true;
