package com.library_for_stickylist;
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {  super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    private class WrapperViewListLifeCycleListener implements com.library_for_stickylist.WrapperViewList.LifeCycleListener {
